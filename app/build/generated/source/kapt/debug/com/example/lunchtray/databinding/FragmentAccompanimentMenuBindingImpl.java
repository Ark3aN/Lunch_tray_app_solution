...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.accMenuFragment == variableId) {
            setAccMenuFragment((com.example.lunchtray.ui.order.AccompanimentMenuFragment) variable);
        }
    ...
    public void setAccMenuFragment(@Nullable com.example.lunchtray.ui.order.AccompanimentMenuFragment AccMenuFragment) {
        this.mAccMenuFragment = AccMenuFragment;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
        notifyPropertyChanged(BR.accMenuFragment);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.AccompanimentMenuFragment accMenuFragment = mAccMenuFragment;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            case 4: {
                ...
                // accMenuFragment
                com.example.lunchtray.ui.order.AccompanimentMenuFragment accMenuFragment = mAccMenuFragment;
                // accMenuFragment != null
                boolean accMenuFragmentJavaLangObjectNull = false;



                accMenuFragmentJavaLangObjectNull = (accMenuFragment) != (null);
                if (accMenuFragmentJavaLangObjectNull) {


                    accMenuFragment.cancelOrder();
                }
                break;
            }
            case 2: {
            ...
            case 5: {
                ...
                if (accMenuFragmentJavaLangObjectNull) {
                    ...
                    accMenuFragment.goToNextScreen();
                }
                break;
            }
            case 3: {
